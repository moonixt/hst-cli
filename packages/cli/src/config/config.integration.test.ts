...
import type { ConfigParameters } from 'hst-cli-core';
import { Config, DEFAULT_FILE_FILTERING_OPTIONS } from 'hst-cli-core';
...
vi.mock('hst-cli-core', async () => {
  const actual = await vi.importActual('hst-cli-core');
  return {
    ...actual,
