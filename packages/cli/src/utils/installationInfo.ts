...
import { debugLogger, isGitRepository } from 'hst-cli-core';
...
export function getInstallationInfo(
  ...
  try {
    ...
    if (realPath.includes('/.pnpm/global')) {
      const updateCommand = 'pnpm add -g hst-cli@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add hst-cli@latest';
      return {
    ...
    if (realPath.includes('/.bun/bin')) {
      const updateCommand = 'bun add -g hst-cli@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g hst-cli@latest';
    return {
