...
import type { Config } from 'hst-cli-core';
import { OutputFormat, FatalInputError } from 'hst-cli-core';
import {
  getErrorMessage,
  handleError,
  handleToolError,
...
vi.mock('hst-cli-core', async (importOriginal) => {
  const original = await importOriginal<typeof import('hst-cli-core')>();
