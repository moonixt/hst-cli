...
import { Config, ApprovalMode } from 'hst-cli-core';
import type { Config as ActualConfigType } from 'hst-cli-core';
...
vi.mock('hst-cli-core', async () => {
  const actualServerModule = await vi.importActual('hst-cli-core');
  return {
    ...actualServerModule,
    Config: vi.fn(),
  };
