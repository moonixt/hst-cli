...
import {
  IDE_DEFINITIONS,
  detectIdeFromEnv,
} from 'hst-cli-core/src/ide/detect-ide.js';

vi.mock('hst-cli-core/src/ide/detect-ide.js', async () => {
  const actual = await vi.importActual('hst-cli-core/src/ide/detect-ide.js');
  return {
    ...actual,
